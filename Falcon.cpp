// Falcon.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CFalconApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CFalconApp construction

CFalconApp::CFalconApp()
{
...
// The one and only CFalconApp object

CFalconApp theApp;


// CFalconApp initialization

BOOL CFalconApp::InitInstance()
{
...
BOOL CFalconApp::ProcessMessageFilter(int code, LPMSG lpMsg)
{
	...
	if (code >= 0 && m_pMainWnd && m_hAccelTable_Help_Menu)
	{
		if (m_hAccelTable_File_Menu && ::TranslateAccelerator(m_pMainWnd->m_hWnd, m_hAccelTable_Help_Menu, lpMsg))
		{
			return TRUE;
		}
	}
